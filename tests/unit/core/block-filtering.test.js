...
describe('Block Filtering for AI Enhancement', () => {
  ...
  it('should filter more blocks with old 100-char threshold', () => {
    const blocks = [
      ...
      {text: 'This is a much longer paragraph that contains well over one hundred characters and would definitely pass the old threshold without any issues.'}, // 140+ chars
    ];
  ...
  it('should preserve exact block text including markdown', () => {
    const blocks = [
      {text: '### Section Header with **bold** and _italic_ text that is long enough'},
    ];
