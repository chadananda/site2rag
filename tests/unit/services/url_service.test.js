...
describe('UrlService', () => {
  ...
  describe('normalizeUrl', () => {
    it('should remove hash and query parameters', () => {
      expect(urlService.normalizeUrl('https://example.com/page?query=123#section'))
    ...
    it('should handle duplicate slashes', () => {
      expect(urlService.normalizeUrl('https://example.com//page///subpage'))
        .toBe('https://example.com/page/subpage');
    });
